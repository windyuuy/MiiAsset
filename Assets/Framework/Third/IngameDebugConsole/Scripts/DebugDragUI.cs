...
{
	public class DebugDragUI : MonoBehaviour, IPointerClickHandler, IBeginDragHandler, IDragHandler, IEndDragHandler
	{
...
#pragma warning disable 0
		[SerializeField]
		private RectTransform MoveSpaceRT;
		[SerializeField]
...
#pragma warning restore 0649
		...
		private void Awake()
		{
			...
			MoveSpaceRT = debugManager.canvasTR;
		...
		{
			Vector2 localPoint;
			if( RectTransformUtility.ScreenPointToLocalPointInRectangle( MoveSpaceRT, data.position, data.pressEventCamera, out localPoint ) )
		...
		{
			Vector2 canvasSize = MoveSpaceRT.rect.size;
