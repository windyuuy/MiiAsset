...
namespace MiiAsset.Runtime
{
	...
	public class AssetConsumerConfig : ScriptableObject, IAssetProvider.IProviderInitOptions
	{
		...
		[Header("热更资源缓存路径")] public string bundleCacheDir = "hotres/";
		public string catalogName = "catalog";
		public string catalogType = "zip";

		[Header("热更通道")] [Tooltip("会打进包里，热更通道一致，才能通过升级版本号来升级热更资源")]
		...
		[Header("是否构建索引代码")] [Tooltip("可以通过生成的索引代码引用资源Tag等, 或观察bundle和依赖变化")]
		...
		{
			var configGuids =
				UnityEditor.AssetDatabase.FindAssets("t:AssetConsumerConfig",
