...
namespace Lang.TypeHelper
{
	...
	{
		public static Dictionary<TKey, TValue> Add<TKey, TValue>(this Dictionary<TKey, TValue> dic, TKey key,
			TValue value)
		{
		...
		public static T DeepCopy<T>(this T obj, int serializeMode)
		{
				...
				using (MemoryStream ms = new MemoryStream())
				{
					var xmlSerializer =
						new System.Xml.Serialization.XmlSerializer(
							obj.GetType()); //无法序列化 System.Collections.Generic.Dictionary`
			...
			{
				throw new ArgumentException("serializeMode 参数不在支持的范围内");
			}
		}
