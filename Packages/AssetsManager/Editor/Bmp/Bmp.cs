    ...
    public partial class Bmp : KaitaiStruct
    {
        ...
        public partial class BitmapHeader : KaitaiStruct
        {
            ...
            private void _read()
            {
                ...
                if (IsColorMaskHere) {
                    _colorMask = new ColorMask(LenHeader != (uint)Bmp.HeaderType.BitmapV2InfoHeader, m_io, this, m_root);
                }
            ...
            public bool ExtendsBitmapV4
            {
                get
                {
                    ...
                    _extendsBitmapV4 = (bool) (LenHeader >= (uint)Bmp.HeaderType.BitmapV4Header);
            ...
            public bool ExtendsOs22xBitmap
            {
                get
                {
                    ...
                    _extendsOs22xBitmap = (bool) (LenHeader == (uint)Bmp.HeaderType.Os22xBitmapHeader);
            ...
            public bool ExtendsBitmapInfo
            {
                get
                {
                    ...
                    _extendsBitmapInfo = (bool) (LenHeader >= (uint)Bmp.HeaderType.BitmapInfoHeader);
            ...
            public bool IsCoreHeader
            {
                get
                {
                    ...
                    _isCoreHeader = (bool) (LenHeader == (uint)Bmp.HeaderType.BitmapCoreHeader);
                    f_isCoreHeader = true;
                    return _isCoreHeader;
                }
            }
            ...
            public bool ExtendsBitmapV5
            {
                get
                {
                    ...
                    _extendsBitmapV5 = (bool) (LenHeader >= (uint)Bmp.HeaderType.BitmapV5Header);
            ...
            public bool IsColorMaskHere
            {
                get
                {
                    ...
                    _isColorMaskHere = (bool) ( ((LenHeader == (uint)Bmp.HeaderType.BitmapV2InfoHeader) || (LenHeader == (uint)Bmp.HeaderType.BitmapV3InfoHeader) || (ExtendsBitmapV4)) );
        ...
        public partial class BitmapInfo : KaitaiStruct
        {
            ...
            public uint ColorMaskBlue
            {
                get
                {
                    ...
                    _colorMaskBlue = (uint) ((IsColorMaskGiven ? ColorMaskGiven.BlueMask : (uint)(Header.BitsPerPixel == 16 ? 31 : ( ((Header.BitsPerPixel == 24) || (Header.BitsPerPixel == 32))  ? 255 : 0))));
            ...
            public int ColorMaskGreen
            {
                get
                {
                    ...
                    _colorMaskGreen = (int) ((IsColorMaskGiven ? ColorMaskGiven.GreenMask : (uint)(Header.BitsPerPixel == 16 ? 992 : ( ((Header.BitsPerPixel == 24) || (Header.BitsPerPixel == 32))  ? 65280 : 0))));
            ...
            public bool IsColorMaskHere
            {
                get
                {
                    if (f_isColorMaskHere)
                        return _isColorMaskHere;
                    _isColorMaskHere = (bool) ( ((!(M_Io.IsEof)) && (Header.LenHeader == (uint)Bmp.HeaderType.BitmapInfoHeader) && ( ((Header.BitmapInfoExt.Compression == Bmp.Compressions.Bitfields) || (Header.BitmapInfoExt.Compression == Bmp.Compressions.AlphaBitfields)) )) );
                    f_isColorMaskHere = true;
                    return _isColorMaskHere;
                }
            }
            ...
            public int ColorMaskRed
            {
                get
                {
                    ...
                    _colorMaskRed = (int) ((IsColorMaskGiven ? ColorMaskGiven.RedMask : (uint)(Header.BitsPerPixel == 16 ? 31744 : ( ((Header.BitsPerPixel == 24) || (Header.BitsPerPixel == 32))  ? 16711680 : 0))));
                    f_colorMaskRed = true;
                    return _colorMaskRed;
                }
            }
        ...
        public Bitmap Bitmap2 { get { return _bitmap; } }
        public Bmp M_Root { get { return m_root; } }
        public KaitaiStruct M_Parent { get { return m_parent; } }
